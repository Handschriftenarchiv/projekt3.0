				...
				<div class="row">
					<div class="col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="/ratser-liste.html"><img class="img-responsive" src="images/blog/liste/1.svg" alt=""></a>
							<div class="blog-text">
					...
					<div class="col-md-4">
						<div class="fh5co-blog animate-box">
							<a href="/gunter-gross.html"><img class="img-responsive" src="images/blog/gross/1.jpg" alt=""></a>
							<div class="blog-text">
				...
				<div class="container">
					...
					<div class="row copy-right">
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<br>
							<p style="color: #000;font-size: small;">v4.0.2</p>
						</div>
					</div>
				</div>
			</div>
