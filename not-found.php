...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>404 - Handschriftenarchiv Dresdner Kreuzchor</title>
			   			...
			   			<div class="col-md-8 col-md-offset-2 col-md-push-4 js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<div class="desc">
			   						...
			   						<h2>404</h2>
			   						<p>Es tut uns leid, aber wir konnten "<?php echo $_SERVER['REQUEST_URI']; ?>" leider nicht finden.</p>
			   					</div>
			   				</div>
			   			</div>
			   		</div>
