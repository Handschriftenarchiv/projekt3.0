				...
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center animate-box">
						<div class="about-content">
							...
							<blockquote>
								<p>Das Handschriftenarchiv Dresdner Kreuzchor nimmt  den Urheber- und Datenschutz im Bezug auf Archivalien und  Digitalisierungen sehr ernst. Nach dem Archivgesetz des Freistaates Sachsen (SächsArchivG) vom 01. Februar 2014 § 10 Abs. 1 dürfen Archivalien erst 30 Jahre nach der Entstehung veröffentlicht werden, sofern sich das Archivgut nicht auf natürliche Personen bezieht. Zweites wurde vom Handschriftenarchiv ausgeschlossen, da es sich im Archivgut um Noten, Drucke und Handschriften handelt, die für die täglichen Chor- und Probengebrauch des Dresdner Kreuzchores und nicht für eine einzelne Person geschaffen wurden. Desweiteren ist es bei den meisten Handschriften nicht möglich, einen Urheber bzw. ein Entstehungsdatum zu ermitteln. In diesem Fall gilt folgendes: Das Archivmaterial des Handschriftenarchivs besteht aus Werken, die für den täglichen Chorgebrauch des Dresdner Kreuzchores geschaffen wurden. Somit geht das Handschriftenarchiv von einer Schenkung, nach § 516 ff. im Bürgerlichen Gesetzbuch, des Urhebers an die Notenbibliothek des Dresdner Kreuzchores aus. Dies ist auf den meisten Archivalien durch einen Stempel des Dresdner Kreuzchores gekennzeichnet. Der ehemalige Noten- und Handschriftenbestand der Notenbibliothek wurde im Jahr  2013 an das Handschriftenarchiv Dresdner Kreuzchor übergeben, damit dieses sich mit der Erfassung und Veröffentlichung dieses Materials, nach dem Grundsatz des Archives folgt, Archivgut, als ein Relikt bedeutender regionaler Geschichte der Öffentlichkeit zur Verfügung zu stellen, befasst. Das heißt, unter der Kooperation zwischen Notenbibliothek des Dresdner Kreuzchores und dem Handschriftenarchiv Dresdner Kreuzchor, haben die Archivalien den rechtlichen Eigentümer gewechselt. Es ist nicht Aufgabe des Handschriftenarchivs, den Urheber bzw. das Erfassungsdatum einer Archivalien zu ermitteln, wenn diese nicht explitzit (Dies meint einen Namen und ein Datum in regulärem Format [schließt Kürzel, Signa aus]) auf einer der Noten, Drucke oder Handschrifen innherlab eines Werkes genannt sind. Das Handschriftenarchiv Dresdner Kreuzchor übernimmt jedoch keine Haftung gegenüber Urheberrechtsansprüchen für Werke im Archiv, die nicht kenntlich gezeichnet sind, durch einen Namen oder ein Verfassungsdatum. Für den Fall das der Urheber bzw. das Entstehungsdatum ermittelt werden konnte gilt das Sächsische Archiv Gesetz in seiner letzten Ausgabe vom 01. Februar 2014.  Nach § 6 Abs. 3  SächsArchivG hat jedermann Recht, zu erfahren, ob im Archivgut Daten zu seiner Person enthalten sind, soweit diese Bestände erfasst sind. <br> Aufgrund dieser Regelungen veröffentlicht das Handschriftenarchiv alle Handschriften, Drucke und Noten im Allgemeinen als Datenbankeintrag und als Digitalisierung. Dies geschieht unter der der Creative Commons Lizenz <strong>by-sa 4.0</strong> . Sollten Sie Urheberrechtsansprüche stellen wollen, nehmen Sie bitte das bisher Erläuterte zur Kenntnis und kontaktieren Sie uns auf elektronischem Wege über unsere Mail Adresse.</p>
							</blockquote>
							<br>
							</div>
							<div id="recht">
